...
For Zenodo DOI archiving, enable this repository in Zenodo's GitHub integration before publishing the next release. The DOI-ready release is `v1.0.1` and uses `RELEASE_NOTES_v1.0.1.md`.
