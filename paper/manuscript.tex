...
\usepackage{pdfpages}
\usepackage{listings}
% \usepackage{inconsolata} % disabled: ec-inconsolata font not available on ScholarOne TeX Live 2021
...
\author[1]{Dawid Kucharski\thanks{Corresponding author: \href{mailto:dawid.kucharski@put.poznan.pl}{dawid.kucharski@put.poznan.pl}}}
\author[2]{Piotr Nies\l ony}
\author[3]{Jolanta Kr\'olczyk}
\author[4]{Grzegorz Kr\'olczyk}
\author[5]{Katarzyna Nici\'nska}
\author[5]{Natalia Wojciechowska}
\author[5]{{\L}ukasz {\'S}lusarski}
\author[1]{Micha\l\ Wieczorowski}
\author[1]{Bartosz Gapi\'nski}
\affil[1]{Poznan University of Technology, Poznan, Poland}
\affil[2]{Opole University of Technology, Opole, Poland}
\affil[3]{Independent Researcher}
\affil[4]{Polish Air Force University, D\k{e}blin, Poland}
\affil[5]{Central Office of Measures, Warsaw, Poland}
\vspace{-5mm}
...
The R/Python analysis scripts, configuration files, manuscript and supplement sources, generated CSV outputs, generated tables, and generated figures supporting the findings are publicly archived at Zenodo (\href{https://doi.org/10.5281/zenodo.19844490}{10.5281/zenodo.19844490}) and GitHub (\href{https://github.com/dawidkucharski/optical-tactile-surface-benchmark}{optical-tactile-surface-benchmark}). Raw \texttt{.sur} surface files are excluded from the public package as original instrument exports with size and transfer constraints; the derived CSV outputs needed to reproduce the manuscript tables, fixed-workflow sensitivity analysis, workflow-transfer check, global heatmap, selection-penalty figure, and supplementary tables are included. The excluded raw \texttt{.sur} files are available from the corresponding author on reasonable request, subject to data-transfer constraints.

\section*{Funding}
This work was supported by the Polish Ministry of Science under the programme ``Polish Metrology~II'' (Polska Metrologia~II), project no.~PM-II/SP/0090/2024/02.
