...
\caption[Ra: optical--tactile comparison for C45 after wire EDM rough cutting (single-pass)]{$R_a$: optical--tactile comparison for C45 after wire EDM rough cutting (single-pass), summarising relative discrepancy across systems}
\end{figure}
\clearpage
